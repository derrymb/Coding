...
// Date :				17/11/2017
// Purpose : 			// Purpose : 			Rewrite the following program using a loop structure of your choice. But this time you implement a 
...

{
    ...
    public static String reverseStr(String str)
    {
    	...
    	int index ;
    	reverse = "";
    	// start at the last character and read through to the 1st character at position Zero.
